...
class KompasSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for post in response.css('div.article__list'):
            ...
            # yield postList
            # yield {
            #     'title'      : post.css("div.article__list__title a::text").extract(),
            #     'link_url'   : post.css("div.article__list__title a::attr(href)").extract(),
            #     'time'       : post.css("div.article__list__info div.article__date::text").extract(),
